...
load("output_models/model1_FWO.RData")
load("output_models/model2_FWO.RData")
load("output_models/model3_FWO.RData")
...
save(loo_comparison_mm, file = "output_models/loo_comparison_mm_FWO.RData")

filepath_loo_comparison_mm <-
  paste0("output_tables/", "loo_comparison_mm_FWO", ".csv", collapse = "")
...
loo_comparison
save(loo_comparison, file = "output_models/loo_comparison_FWO.RData")
filepath_loo_comparison <-
  paste0("output_tables/", "loo_comparison_FWO", ".csv", collapse = "")
