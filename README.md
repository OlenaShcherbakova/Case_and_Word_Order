...
1. Run ```library.R``` for all packages, custom functions, and generating/transforming input files. This will also generate an Appendix with the full list of languages and relevant feature values. Run `get_external_data.R` to fetch input data from Grambank, AUTOTYP, and Glottolog.
