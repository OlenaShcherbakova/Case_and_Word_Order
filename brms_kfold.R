...
kfold_comparison <- brms::kfold(model1, model2, model3, K=10, chains=1, save_fits = TRUE, compare=TRUE)

save(kfold_comparison, file = "output_models/kfold_comparison.RData")
...
filepath_kfold_comparison <- paste0("output_tables/", "kfold_comparison", ".csv", collapse = "")
