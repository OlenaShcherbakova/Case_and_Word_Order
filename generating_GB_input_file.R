#This script is intended for generating the Grambank input file from the entire database
#This final input file includes: 
#5 relevant Gramabank features 
#the sample of 1705 languages for which values are either "0" or "1", i.e. with no missing values.
...
colnames(grambank_phylopath_compl)[colnames(grambank_phylopath_compl) ==
                                     "Language_ID"] <- "Glottocode"

grambank_phylopath_compl <-
  grambank_phylopath_compl[!with(
    grambank_phylopath_compl,
    is.na(GB070) |
