...
load("output_models/model1.RData")
load("output_models/model2.RData")
load("output_models/model3.RData")
...
loo_comparison_mm <- brms::loo(model1, model2, model3, moment_match = TRUE)
cat("LOO comparison between the models with moment match set to TRUE")
loo_comparison_mm

save(loo_comparison_mm, file = "output_models/loo_comparison_mm.RData")

filepath_loo_comparison_mm <- paste0("output_tables/", "loo_comparison_mm", ".csv", collapse = "")
...
loo_comparison
save(loo_comparison, file = "output_models/loo_comparison.RData")
filepath_loo_comparison <- paste0("output_tables/", "loo_comparison", ".csv", collapse = "")
...
filepath_pareto_k <- paste0("output_tables/", "loo_comparison_pareto_k", ".csv", collapse = "")
